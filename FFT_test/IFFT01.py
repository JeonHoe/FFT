...
plt.subplot(2,1,2)
plt.stem(n1,X3k,'b'); plt.ylabel("|X1(k)|"); plt.grid()

plt.figure(5)
plt.subplot(2,1,1)
plt.stem(n1,magX2k,'b'); plt.ylabel("|X2(k)|"); plt.grid(); plt.title("Reconstructed of x[n]");
plt.subplot(2,1,2)
plt.stem(n1,xrn,'b'); plt.ylabel("xr[n]"); plt.grid()

plt.figure(6)
plt.subplot(2,1,1)
plt.stem(n1,magX2k,'b'); plt.ylabel("|X2(k)|"); plt.grid(); plt.title("Reconstructed of x[n]");
plt.subplot(2,1,2)
plt.stem(n1,xrrn,'b'); plt.ylabel("xr[n]"); plt.grid()
plt.show()